...
export const apps: AppMeta[] = [
  ...
  { id: 'notepad', title: 'GemNotes', icon: 'https://storage.googleapis.com/gemini-95-icons/GemNotes.png' },
  { id: 'paint', title: 'GemPaint', icon: 'https://storage.googleapis.com/gemini-95-icons/gempaint.png' },
  ...
  { id: 'minesweeper', title: 'GemSweeper', icon: 'https://storage.googleapis.com/gemini-95-icons/gemsweeper.png' },
  { id: 'mediaPlayer', title: 'GemPlayer', icon: 'https://storage.googleapis.com/gemini-95-icons/ytmediaplayer.png' },
